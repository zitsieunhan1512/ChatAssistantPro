...
import app.mbl.hcmute.chatApp.base.util.GlideApp
import app.mbl.hcmute.chatApp.util.exception.ReactiveClickException
...
fun ImageView.load(url: String?, @DrawableRes placeholderRes: Int = R.drawable.ic_cloud_download, activity: Activity? = null, ) {
